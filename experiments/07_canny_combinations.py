""" Experiment 7: Tests which settings are suitable for pre- and post-processing at canny-detector.
    ...
    * Closing with kernel size = 5 and kernel form = Ellipse (for fill the wall and smoothing the text better)
    For Post-Processing is the following setting recommended:
    * Closing with kernel size = 7 and kernel form = Rectangle (for fill the white corners in the wall)
"""
import cv2
